package br.com.curso.spring_keycloak.systems.keycloak.services.impl;
...
public class KeycloakServiceImpl implements KeycloakService {
    ...
    /**
     * Atualiza o token de acesso do administrador.
     */
    ...
    /**
     * Verifica se o token de acesso do administrador está expirado.
     *
    ...
    /**
     * Valida se o idioma fornecido está na lista de idiomas suportados pelo Keycloak.
     *
     * @param localeParam     o idioma a ser validado.
     * @param localesKeycloak a lista de idiomas suportados pelo Keycloak.
     * @return true se o idioma é válido, false caso contrário.
     */
